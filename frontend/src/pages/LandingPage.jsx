...
export default function LandingPage() {
  ...
  // Scroll reveal hooks for smooth entrance animations
  ...
  return (
    <div className="space-y-24 py-12 sm:py-16 relative overflow-hidden">
      {/* Ambient background glows for rich depth */}
      <div className="absolute top-20 left-1/2 -translate-x-1/2 w-[700px] h-[350px] bg-gradient-to-tr from-brand-600/10 via-indigo-500/15 to-cyan-500/10 rounded-full blur-3xl pointer-events-none animate-pulse-glow" />
      <div className="absolute top-96 -left-32 w-80 h-80 bg-brand-500/10 rounded-full blur-3xl pointer-events-none animate-float-slow" />
      <div className="absolute top-[600px] -right-32 w-96 h-96 bg-cyan-500/10 rounded-full blur-3xl pointer-events-none animate-float-slow delay-300" />

      {/* Hero Section */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-8 sm:pt-12 relative z-10 animate-fade-in-up">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-brand-50 dark:bg-brand-950/60 border border-brand-200 dark:border-brand-900 text-brand-700 dark:text-brand-300 text-xs font-bold uppercase tracking-wider mb-8 shadow-xs animate-bounce-subtle">
        ...
        <div className="mt-10 max-w-2xl mx-auto">
          ...
          <div className="mt-4 flex flex-wrap items-center justify-center gap-4 sm:gap-6 text-xs text-slate-500 dark:text-slate-400 font-medium">
            ...
            <button
              ...
              className="text-brand-600 dark:text-brand-400 underline hover:opacity-80 font-semibold cursor-pointer"
            >
              View Demo Dashboard
            </button>
          </div>
        ...
        <div className="mt-16 max-w-4xl mx-auto rounded-3xl border border-slate-200/80 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl p-6 sm:p-8 shadow-2xl transition-all duration-300 hover:shadow-brand-500/10">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 items-center">
            <div className="md:col-span-1 flex flex-col items-center border-b md:border-b-0 md:border-r border-slate-200 dark:border-slate-800 pb-6 md:pb-0 md:pr-6">
              ...
              <span className="text-xs text-slate-500 mt-2 font-medium">Sample Real-World Audit</span>
            </div>
            ...
            <div className="md:col-span-3 space-y-3 text-left">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                <div className="p-3 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200/60 dark:border-slate-800 hover:scale-[1.02] transition-transform">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((f, i) => {
            ...
            return (
              <div
                key={i}
                className="group relative p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-sm hover:shadow-2xl hover:border-brand-500/40 dark:hover:border-brand-500/40 transition-all duration-300 hover:-translate-y-1.5"
              >
                <div className="flex items-center justify-between mb-6">
                  <div className="w-12 h-12 rounded-2xl bg-brand-50 dark:bg-brand-950/60 text-brand-600 dark:text-brand-400 flex items-center justify-center group-hover:scale-110 group-hover:rotate-3 transition-transform">
                    <Icon className="w-6 h-6" />
                  </div>
                  <span className="px-2.5 py-1 text-[11px] font-bold uppercase rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300">
                    {f.badge}
                  </span>
                </div>
      ...
      >
        <div className="rounded-3xl bg-slate-900 text-white p-8 sm:p-16 border border-slate-800 relative overflow-hidden shadow-2xl">
          {/* Subtle geometric glow in corner */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10">
            {steps.map((s, idx) => (
              <div key={idx} className="flex flex-col space-y-3 group">
                <span className="text-4xl font-extrabold text-brand-500/30 dark:text-brand-400/30 font-mono group-hover:text-brand-400 transition-colors">
                  {s.number}
                </span>
                <h4 className="text-lg font-bold text-white group-hover:text-brand-300 transition-colors">{s.title}</h4>
      ...
      >
        <div className="relative rounded-3xl bg-gradient-to-br from-brand-900 via-indigo-950 to-slate-950 p-8 sm:p-14 text-center text-white overflow-hidden shadow-2xl border border-indigo-500/30">
          <div className="absolute top-0 right-0 -mt-10 -mr-10 w-80 h-80 bg-brand-500/15 rounded-full blur-3xl pointer-events-none animate-pulse-glow" />
          <div className="absolute bottom-0 left-0 -mb-10 -ml-10 w-80 h-80 bg-indigo-500/15 rounded-full blur-3xl pointer-events-none animate-float-slow" />
          ...
          <div className="relative z-10 max-w-3xl mx-auto space-y-6">
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3.5">
              <button
                ...
                className="w-full sm:w-auto px-8 py-3.5 rounded-xl font-extrabold text-sm text-slate-950 bg-white hover:bg-slate-100 shadow-lg shadow-white/10 hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-2 cursor-pointer"
              >
              ...
              <button
                ...
                className="w-full sm:w-auto px-8 py-3.5 rounded-xl font-bold text-sm text-white bg-indigo-600/80 hover:bg-indigo-600 border border-indigo-400/40 hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-2 cursor-pointer"
              >
